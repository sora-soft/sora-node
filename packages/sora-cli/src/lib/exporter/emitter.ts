...
import {type ResolvedType} from './type-resolver';
import {type TransformedDeclaration} from './transformer';

const FILE_HEADER = '// Auto-generated by sora export:api\n\n';
...
class Emitter {
  ...
  emitFile(
    ...
    const content = FILE_HEADER + raw.replace(/^( {4})+/gm, match => '  '.repeat(match.length / 4));
