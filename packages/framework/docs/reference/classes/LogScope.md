...
[@sora-soft/framework API Reference](../globals.md) / LogScope
...
[`Scope`](Scope.md).[`constructor`](Scope.md#constructor)
...
[`Scope`](Scope.md).[`store_`](Scope.md#store_)
...
[`Scope`](Scope.md).[`store`](Scope.md#store)
...
[`Scope`](Scope.md).[`isInChain`](Scope.md#isinchain)
...
[`Scope`](Scope.md).[`run`](Scope.md#run)
...
[`Scope`](Scope.md).[`setStore`](Scope.md#setstore)
