...
[@sora-soft/framework API Reference](../globals.md) / RootScope

# Class: RootScope

Defined in: [packages/framework/src/lib/context/scope/RootScope.ts:3](https://github.com/sora-soft/sora-monorepo/blob/b502ee5b534689cc7d2350abf8d8b0ff780961fe/packages/framework/src/lib/context/scope/RootScope.ts#L3)

## Extends

- [`LogScope`](LogScope.md)\<`void`\>
...
Defined in: [packages/framework/src/lib/context/scope/RootScope.ts:4](https://github.com/sora-soft/sora-monorepo/blob/b502ee5b534689cc7d2350abf8d8b0ff780961fe/packages/framework/src/lib/context/scope/RootScope.ts#L4)
...
[`Scope`](Scope.md).[`id_`](Scope.md#id_)
...
[`Scope`](Scope.md).[`parent_`](Scope.md#parent_)
...
[`Scope`](Scope.md).[`stack_`](Scope.md#stack_)

***

### store\_

> `protected` **store\_**: `void`
...
Defined in: [packages/framework/src/lib/context/scope/RootScope.ts:8](https://github.com/sora-soft/sora-monorepo/blob/b502ee5b534689cc7d2350abf8d8b0ff780961fe/packages/framework/src/lib/context/scope/RootScope.ts#L8)
...
[`Scope`](Scope.md).[`parent`](Scope.md#parent)
...
[`Scope`](Scope.md).[`stack`](Scope.md#stack)
